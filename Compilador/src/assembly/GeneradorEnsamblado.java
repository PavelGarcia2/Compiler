...
public class GeneradorEnsamblado {
    ...
    public void generarCodigoMain() {
        ...
        for (int i = 0; i < tablaVariables.getNV(); i++) {
            if (tablaVariables.get(i).getTipo() == Tipo.tsb_str && !tablaVariables.get(i).esArray()) {
        ...
        switch (instruccion.getTipoIntruccion()) {
            ...
            System.out.println("INDASS");
                ...
                if (instruccion.getOperadores()[0].getReferencia() != -2) {
                    ...
                    // instruccion.getOperadores()[0].getTipo());
                    // System.out.println(instruccion.getOperadores()[0].getValString());
            ...
            System.out.println("INDVAL");
                ...
                ensamblado.append(espacioEtiqueta + "MOVE.L" + espacioNormal + "(A0), D0 ; D0 = B[C]\n");
                // En los strings no se ejecuta este store
                if (instruccion.getOperadores()[2].getValString() == "default") {
                    STORE("D0", tablaVariables.get(instruccion.getOperadores()[2].getReferencia()).getIdProcedimiento(),
                            instruccion.getOperadores()[2].getReferencia());
                } else {
                    // M1
                    ensamblado.append(espacioEtiqueta + "MOVE.L" + espacioNormal + "D0" + ", " + "Variable"
                            + instruccion.getOperadores()[2].getReferencia() + " ; Store local variable\n");
                }
            ...
            case CALL:
                ...
                ensamblado.append(espacioEtiqueta + "JSR" + espacioNormal + "e" + label + " ; GOTO " + label + "\n"); // Make
                // the
                // jump,
                // we
                // have
            ...
            case GOTO:
                ...
                ensamblado.append(
                        espacioEtiqueta + "JMP" + espacioNormal + "e" + instruccion.getOperadores()[2].getEtiqueta()
                                + '\n');
            ...
            case IFMENORIGUAL:
                ...
                // System.out.println("ACABA IFMENORIGUAL");
                break;
            ...
            case MODULO:
                ...
                ensamblado.append(espacioEtiqueta + "MODM" + espacioNormal + "D1, D0\n");

                STORE("D1", tablaVariables.get(instruccion.getOperadores()[2].getReferencia()).getIdProcedimiento(),
                        instruccion.getOperadores()[2].getReferencia());

                // System.out.println("ACABO MOD");
                break;
            ...
            case PREAMBULO:
                ...
                if (instruccion.getOperadores()[2].getEtiqueta() == main) {
                    ...
                    // System.out.println("YEYEMANIN:
                    // "+instruccion.getOperadores()[2].getEtiqueta());
                    ArrayList<Dargin> params = tablaProcedimientos.get(instruccion.getOperadores()[2].getEtiqueta())
                            .getParametros();
            ...
            case SKIP:
                // System.out.println("Equeta de skip: " +
                // instruccion.getOperadores()[2].getEtiqueta());
            ...
            case PARAM_SIMPLE:
                ...
                if (tablaVariables.get(variableId).getTipo() != Tipo.tsb_str) {
                    ...
                    ensamblado
                            .append(espacioEtiqueta + "MOVE.L" + espacioNormal + "D0, (Variable" + variableId + ") \n");
                }
                listaParametros.add(variableId);

                if (tablaVariables.get(variableId).getTipo() == Tipo.tsb_str) {
                    ensamblado.append(espacioEtiqueta + "LEA" + espacioNormal + "SParam" + contadorStr + ", "
                            + "A1 ; Param gest\n");
                    ...
                    ensamblado.append(espacioEtiqueta + "MOVE.L" + espacioNormal + '(' + "Variable" + variableId + "), "
                            + '(' + "Param" + counter + ") ; Param\n");
                }
                counter++;
    ...
    private void STORE(String register, String procedureId, int variableId) {
        ...
        // System.out.println("HAGO EL STORE de variableId: " + variableId);
